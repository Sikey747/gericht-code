...
// Документація по роботі у шаблоні: https://legosite.kz/ts/fls/
// Сніппет (HTML): pl
...
import { isMobile, bodyLockStatus, bodyLock, bodyUnlock, bodyLockToggle, FLS } from "/src/js/files/functions.js";
...
class Popup {
	...
	_openToHash() {
		...
		if (buttons) {
			this.youTubeCode = buttons.getAttribute(this.options.youtubeAttribute) || null;
		} else {

...
tp.addListener('load', window, function() {
    ...
    for (var i in inputs) {
        if (typeof inputs[i] == 'object') {
            if (inputs[i].getAttribute("type") == "timepicker" || inputs[i].getAttribute("data-type") == "timepicker") {
